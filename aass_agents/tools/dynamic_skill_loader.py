...
DOMAIN_MCP_MAP: dict[str, list[str]] = {
    ...
    "_core": ["docs", "fetch", "duckduckgo", "thinking", "memory", "github", "wikipedia"],

    # Design (available to all visual-heavy domains)
    "_design": ["image_gen", "charts", "diagrams", "svg", "drawio", "colors"],

    # Industries (30+)
    "agriculture": ["sqlite", "calc", "time", "charts", "weather", "image_gen"],
    "ecommerce": ["npm_search", "packages", "cve", "image_gen", "charts", "svg",
                   "ecom", "lighthouse", "a11y", "colors", "screenshot", "qrcode"],
    "finance": ["calc", "cve", "sqlite", "time", "charts", "diagrams", "findata", "currency",
                "duckdb", "excel", "pdf", "sec_audit"],
    "healthcare": ["cve", "sqlite", "time", "charts", "diagrams", "fhir", "pdf"],
    "education": ["npm_search", "image_gen", "charts", "svg",
                  "edu", "pdf", "arxiv", "wikipedia"],
    "social": ["npm_search", "browser", "image_gen", "svg", "websocket",
               "screenshot", "lighthouse", "a11y", "colors"],
    "project_management": ["npm_search", "tasks", "sqlite", "time", "charts", "diagrams", "drawio",
                           "ci", "git"],
    "content": ["pandoc", "npm_search", "image_gen", "svg", "charts",
                "pdf", "md_tools", "ascii"],
    "analytics": ["sqlite", "calc", "npm_search", "charts", "diagrams",
                  "duckdb", "plot", "excel", "data_transform"],
    "real_estate": ["sqlite", "calc", "duckduckgo", "image_gen", "charts",
                    "pdf", "currency", "screenshot"],
    "logistics": ["sqlite", "calc", "time", "duckduckgo", "charts", "diagrams",
                  "weather", "qrcode"],
    "manufacturing": ["sqlite", "calc", "time", "charts", "diagrams", "qrcode",
                      "plot", "excel", "data_transform"],
    "legal": ["pandoc", "duckduckgo", "cve", "legal", "pdf",
              "arxiv", "sec_audit"],
    "hr": ["sqlite", "time", "charts", "pdf", "calendar"],
    "marketing": ["duckduckgo", "npm_search", "browser", "image_gen", "charts", "svg",
                  "screenshot", "lighthouse", "a11y", "colors", "hacker_news", "rss"],
    ...
    "iot": ["sqlite", "calc", "time", "npm_search", "diagrams", "charts", "mqtt",
            "websocket", "webhook", "weather"],
    "gaming": ["npm_search", "code_analysis", "image_gen", "svg",
               "colors", "audio", "websocket"],
    "ai_ml": ["npm_search", "calc", "duckduckgo", "code_analysis", "charts", "diagrams",
              "tokenizer", "dataset", "plot", "arxiv", "vector_db", "duckdb"],
    "telecom": ["sqlite", "calc", "diagrams", "charts", "dns",
                "mqtt", "websocket"],
    "energy": ["sqlite", "calc", "time", "charts", "diagrams", "weather",
               "plot", "data_transform"],
    "insurance": ["sqlite", "calc", "charts", "pdf",
                  "findata", "currency", "excel", "data_transform"],
    "automotive": ["sqlite", "calc", "charts", "diagrams",
                   "plot", "image_gen"],
    "food_service": ["sqlite", "time", "charts", "image_gen", "qrcode",
                     "calendar", "weather", "ecom"],
    "travel": ["sqlite", "time", "charts", "image_gen", "weather", "currency",
               "calendar", "wikipedia", "screenshot"],
    "media": ["npm_search", "image_gen", "svg", "charts", "audio", "video",
              "colors", "screenshot"],
    "government": ["sqlite", "charts", "diagrams", "pdf", "sec_audit",
                   "a11y", "data_transform", "excel"],
    "nonprofit": ["sqlite", "charts", "image_gen", "pdf",
                  "calendar"],
    "supply_chain": ["sqlite", "calc", "time", "charts", "diagrams", "qrcode",
                     "webhook", "data_transform", "excel"],
